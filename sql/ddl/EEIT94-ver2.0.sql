...
VALUES
('張三', 'zhangsan@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '熱愛健身的上班族', 'user', '2023-01-15 09:30:00'),
('李四', 'lisi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '健身教練', 'admin', '2023-01-16 10:15:00'),
('王五', 'wangwu@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '瑜伽愛好者', 'user', '2023-01-17 14:20:00'),
('趙六', 'zhaoliu@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '營養師', 'user', '2023-01-18 16:45:00'),
('錢七', 'qianqi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '馬拉松跑者', 'user', '2023-01-19 08:10:00'),
('孫八', 'sunba@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '健身新手', 'user', '2023-01-20 11:30:00'),
('周九', 'zhoujiu@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '重量訓練愛好者', 'user', '2023-01-21 13:15:00'),
('吳十', 'wushi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '舞蹈老師', 'user', '2023-01-22 15:40:00'),
('鄭十一', 'zhengshiyi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '游泳健將', 'user', '2023-01-23 17:25:00'),
('王十二', 'wangshier@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '健身網紅', 'user', '2023-01-24 19:00:00'),
('林十三', 'linshisan@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '健身器材專家', 'user', '2023-01-25 20:35:00'),
('陳十四', 'chenshisi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '營養學博士', 'user', '2023-01-26 09:50:00'),
('黃十五', 'huangshiwu@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '健身教練', 'admin', '2023-01-27 11:15:00'),
('劉十六', 'liushiliu@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '瑜伽導師', 'user', '2023-01-28 14:30:00'),
('高十七', 'gaoshiqi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '健身器材店老闆', 'user', '2023-01-29 16:45:00'),
('謝十八', 'xieshiba@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '健身營養顧問', 'user', '2023-01-30 18:10:00'),
('羅十九', 'luoshijiu@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '健身部落客', 'user', '2023-01-31 20:35:00'),
('蔡二十', 'caiershi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '健身模特兒', 'user', '2023-02-01 09:00:00'),
('葉廿一', 'yenianyi@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'M', '健身器材研發', 'user', '2023-02-02 11:25:00'),
('許廿二', 'xunianer@example.com', '5f4dcc3b5aa765d61d8327deb882cf99', 'F', '健身營養品銷售', 'user', '2023-02-03 13:50:00')
GO
...
VALUES
('蛋白粉', '乳清蛋白粉，巧克力口味', 1200.00, 100, 'https://example.com/protein.jpg'),
...
VALUES
('初級瑜伽', '適合初學者的瑜伽課程', '2023-03-01', 3, 60, 15),
...
VALUES
(1, '雞胸肉', 200, 40.0, 0.0, 5.0, 'lunch', '2023-02-01 12:00:00'),
...
VALUES
(1, 'goal_completed', '減重5公斤達成', '成功達成減重目標', '2023-01-15 10:00:00'),
...
VALUES
('fitness', '我的健身旅程', '分享我從開始健身到現在的心得...', 1, '2023-02-01 10:00:00', '2023-02-01 10:00:00'),
('nutrition', '健康飲食建議', '分享一些我認為很有效的健康飲食方法...', 2, '2023-02-02 11:15:00', '2023-02-02 11:15:00'),
('recipe', '高蛋白早餐食譜', '這是我每天早上都會吃的高蛋白早餐...', 3, '2023-02-03 14:30:00', '2023-02-03 14:30:00'),
...
('fitness', '在家健身指南', '沒有時間去健身房？在家也能有效健身...', 7, '2023-02-07 13:15:00', '2023-02-07 13:15:00'),
...
VALUES
(1, 2, '寫得真好，我也要開始健身了！', '2023-02-01 11:00:00', '2023-02-01 11:00:00'),
